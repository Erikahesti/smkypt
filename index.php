...
<div id="container">
  <table width="1011" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="150" colspan="3" valign="top" bgcolor="#FFFF00"><img src="header22.jpg" alt="" width="1011" height="206"></td>
    </tr>
    <tr>
      <td  colspan="3" valign="top" bgcolor="#990000" style="padding:10px; color:#FFF">
    ...
    <tr>
      <td colspan="10" align="center" valign="top" bgcolor="#FFFFCC" class="row-padding"><div align="center">
    ...
    <tr>
      <td colspan="3" valign="top" bgcolor="#00CC00">
      <div class="w3-content w3-display-container">

<div class="w3-display-container mySlides">
  <img src="gambar/gambar1.png" style="width:100%">
</div>

<div class="w3-display-container mySlides">
  <img src="gambar/gambar3.png" style="width:100%">
</div>
...
<button class="w3-button w3-display-right w3-black" onclick="plusDivs(1)">&#10095;</button>
    ...
    <tr valign="top">
      <td width="212" rowspan="2" bgcolor="#FFFFCC" cellspacing="0" cellpadding="5"><?php include "kiri.php"; ?><p class="footer-text">&nbsp;</p></td>
      <td width="581" bgcolor="#FFFFFF" style="padding:10px;"><?php include "menu.php"; ?>
      </td>
      <td width="218" bgcolor="#FFFFCC"><?php include "kanan.php"; ?></td>
    </tr>
    <tr>
      <td align="center" valign="top" bgcolor="#990000"><span class="footer-text">Copyright &copy; 2025 By Erika</br>

...
<div id="container">
  <table width="1011" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="150" colspan="3" valign="top" bgcolor="#FFFF00"><img src="header2.JPG" width="1001" height="206"></td>
    </tr>
    <tr>
      <td  colspan="3" valign="top" bgcolor="#FF66CC" style="padding:10px;"><marquee>
...
<button class="w3-button w3-display-right w3-black" onclick="plusDivs(1)">&#10095;</button>
    ...
    <tr valign="top">
      <td width="212" bgcolor="#FF66CC" cellspacing="0" cellpadding="5"><?php include "kiri.php"; ?></td>
      <td width="581" bgcolor="#FFFF00" style="padding:10px;"><?php include "menu.php"; ?>
      </td>
      <td width="218" bgcolor="#FF66CC"><?php include "kanan.php"; ?></td>
    </tr>
    <tr>
      <td colspan="3" align="center" valign="top" bgcolor="#990066"><p class="footer-text">Copyright &copy; 2019</br>
     
      AMIK Bina Sriwijaya Palembang<br>
      Jl. H.M Ryacudu 24 Telp. 0711-5210019<br>
      Website: www.binasriwijaya.ac.id Email: info@binasriwijaya.ac.id      </p></td>
    </tr>
  </table>
</div>
<script>

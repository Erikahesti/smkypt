...
$query_siswa = "SELECT * FROM pendaftaran WHERE tgl_daftar LIKE '$_GET[tahun]%'";
...
<table width="900" border="1" align="center" cellpadding="5" cellspacing="0">
  <tr>
    ...
    <p>&nbsp;</p></td>
    <td width="136" align="center"><img src="../gambar/logo11.jpg" alt="" width="152" height="123" align="left" /></td>
  </tr>
  <tr>
    <td colspan="2" align="center"><p>&nbsp;</p>
      <p><strong>LAPORAN DATA PENDAFTARAN</strong></p>
      <p>&nbsp; 
        <strong>TAHUN <?php echo "$_GET[tahun]";?></strong>
      <p>
      <p>&nbsp; </p>      

...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE berita SET judul=%s, isi_berita=%s WHERE id_berita=%s",
...
mysql_select_db($database_koneksi, $koneksi);
$query_DetailRS1 = sprintf("SELECT * FROM berita WHERE id_berita = %s ORDER BY id_berita ASC", GetSQLValueString($colname_DetailRS1, "int"));
...
<p align="center">EDIT BERITA</p>
<form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1">
  <table width="400" align="center">
    <tr valign="baseline">
      <td align="left" valign="top" nowrap>Id berita</td>
      <td align="left" valign="top" nowrap>:</td>
      <td align="left" valign="top"><input name="id_berita" type="text" value="<?php echo $row_DetailRS1['id_berita']; ?>" size="15" readonly="readonly"></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="left" valign="top"><span id="sprytextarea1">
        <label for="isi"></label>
        <textarea name="isi_berita" id="isi" cols="35" rows="5"><?php echo $row_DetailRS1['isi_berita']; ?></textarea>

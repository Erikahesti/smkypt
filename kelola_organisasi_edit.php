...
$gambarnya = $_FILES['gambar']['name'];
  ...
  if($gambarnya==''){
  $updateSQL = sprintf("UPDATE organisasi SET judul=%s, isi=%s WHERE id_organisasi=%s",
                       GetSQLValueString($_POST['judul'], "text"),
                       GetSQLValueString($_POST['isi'], "text"),
                       GetSQLValueString($_POST['id_organisasi'], "int"));
					   
  }else{
  $updateSQL = sprintf("UPDATE organisasi SET judul=%s, isi=%s, gambar=%s WHERE id_organisasi=%s",
                       GetSQLValueString($_POST['judul'], "text"),
                       GetSQLValueString($_POST['isi'], "text"),
...
mysql_select_db($database_koneksi, $koneksi);
$query_DetailRS1 = sprintf("SELECT * FROM organisasi WHERE id_organisasi = %s ORDER BY id_organisasi ASC", GetSQLValueString($colname_DetailRS1, "int"));
...
<p align="center">EDIT ORGANISASI</p>
<form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1">
  <table width="400" align="center">
    <tr valign="baseline">
      <td align="left" valign="top" nowrap>Id Organisasi</td>
      <td align="left" valign="top" nowrap>:</td>
      <td align="left" valign="top"><input name="id_organisasi" type="text" value="<?php echo $row_DetailRS1['id_organisasi']; ?>" size="15" readonly="readonly"></td>
    </tr>
    <tr valign="baseline">
